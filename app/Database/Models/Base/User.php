...
abstract class User implements ActiveRecordInterface 
{
    ...
    public function setRemember($v)
    {
        ...
        if ($this->remember !== $v) {
            $this->remember = $v;
            $this->modifiedColumns[UserTableMap::COL_REMEMBER] = true;
        }
    ...
    public function setAccountType($v)
    {
        ...
        if ($this->account_type !== $v) {
            $this->account_type = $v;
            $this->modifiedColumns[UserTableMap::COL_ACCOUNT_TYPE] = true;
        }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setRemember($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setAccountType($arr[$keys[5]]);
        }
